public class Idman {
    ...
    public  void sithupYap(int sayi){
        ...
        if(situp_sayisi < sayi){
            System.out.println("Hedeflediğin sithup sayısını geçtin. Tebrikler.");
            situp_sayisi = 0;
            System.out.println("Kalan Sithup Sayısı: "+ situp_sayisi);
        }
        else{
            situp_sayisi -= sayi;
            System.out.println("Kalan Sithup Sayısı: "+ situp_sayisi);
    ...
    public  boolean idmanBittiMi(){
        return (pushup_sayisi==0) && (squat_sayisi==0) && (situp_sayisi==0) && (burpee_sayisi==0);
    }
